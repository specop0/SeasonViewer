...
{
    public class SeleniumMiner : ISeleniumMiner
    {
        ...
        public async Task<ICollection<Anime>> MineAnimesAsync(ICollection<Anime> animes)
        {
        ...
        public async Task<ICollection<Anime>> MineSeasonAnimeAsync(string season)
        {
            ...
            {
                var body = await response.Content.ReadAsStringAsync();
                return ParseSeasonAnime(body, season);
            }

            return [];
        }

        public static ICollection<Anime> ParseSeasonAnime(string body, string season)
        {
            var pageSourceResult = body.Deserialize<MinePageSourceResult>();
            var pageSource = pageSourceResult?.PageSource;
            if (pageSource is null)
        ...
        public async Task<ICollection<MalListMineResult>> MineMalListAsync(string user)
        {
            ...
            {
                var body = await response.Content.ReadAsStringAsync();
                return ParseMalList(body);
            }

            return [];
        }

        public static ICollection<MalListMineResult> ParseMalList(string body)
        {
            var pageSourceResult = body.Deserialize<MinePageSourceResult>();
            var pageSource = pageSourceResult?.PageSource;
            if (pageSource is null)
        ...
        public async Task<MyAnimeList?> MineMalAsync(Anime anime)
        {
            var newAnime = await this.MineAnimeAsync(anime.Mal.Id);
        ...
        public async Task<ICollection<Hoster>> MineHosterAsync(Anime anime)
        {
        ...
        public async Task<ICollection<DuckDuckGoSearchItem>> MineDuckDuckGoSearchAsync(string searchQuery)
        {
        ...
        public static ICollection<DuckDuckGoSearchItem> ParseDuckDuckGoSearch(string body)
        {
