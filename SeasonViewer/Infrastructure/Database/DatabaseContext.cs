...
namespace SeasonViewer.Infrastructure.Database
{
    ...
    {
        public DatabaseContext(LiteDatabase database, IHosterService hosterService)
        {
            this.Data = database;
        ...
        public Anime? GetAnimeByMalId(string malId)
        {
            return this.GetAnimeCollection().FindOne(x => x.Mal.Id == malId);
        }
        ...
        public void UpdateSeasonAnimes(string season, ICollection<Anime> animes)
        {
